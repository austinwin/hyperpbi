...
function mount(live = true) {
    ...
    function Harness() { const [json, setJson] = useState(mapStudioSpecification); return <MapStudio json={json} data={mapStudioData} selectedComponentId="operations" liveViewport={live ? { bounds: [-97, 28, -93, 32], center: [30.5, -94.5], zoom: 11, width: 800, height: 600 } : undefined} onChange={next => { latest = next; setJson(next); }} />; }
