...
describe("Map Studio interaction editor", () => {
    it("authors the existing interaction contract and reports compatibility", () => {
        const mounted = mountMapStudio(); act(() => button(mounted.host, "interaction").click());
    ...
    it("does not imply external selection for reference-only ArcGIS features", () => {
        const mounted = mountMapStudio(); act(() => button(mounted.host, "Add ArcGIS feature layer").click()); act(() => button(mounted.host, "interaction").click());
