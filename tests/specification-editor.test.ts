...
describe("canonical editor container coverage", () => {
    it("traverses every declared root and nested container with exact pointers", () => {
        const dashboard = {
            ...
            components: [
                ...
                { type: "tabs", id: "all-tabs", tabs: [
                    ...
                    { id: "components", title: "Components", components: [{ type: "text", id: "tab-components" }] },
                    { id: "content", title: "Content", content: [{ type: "text", id: "tab-content" }] },
                ] },
        ...
        expect(componentTree(dashboard).map(item => item.path)).toEqual(expect.arrayContaining([
            ...
            "/components/1/tabs/0/children/0", "/components/1/tabs/1/components/0", "/components/1/tabs/2/content/0",
