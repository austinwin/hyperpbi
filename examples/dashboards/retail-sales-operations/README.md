...
All logical datasets use the portable `powerbi` source alias. The CSV has 19 fields, below the visual's 50-field limit, and 89 rows, below the 30,000-row Power BI window.
