...
export function SetupExperience({ data }: { data: NormalizedData }) {
    return <div class="hp-product-page hp-setup hp-setup-ai">
        <header><div class="hp-product-mark">H</div><div><h1>HyperPBI</h1><p>{data.rows.length.toLocaleString()} rows · {Object.keys(data.fields).length} fields ready</p></div></header>
        <main>
