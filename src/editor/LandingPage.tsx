...
export function LandingPage() {
    return <div class="hp-product-page hp-landing-v2">
        <header><div class="hp-product-mark">H</div><div><h1>HyperPBI</h1><p>AI-powered enterprise dashboard designer for Power BI · Designed, Developed and Maintained by H.Nguyen - WWO - <a href="https://hyperpbi.com" target="_blank" rel="noreferrer">HyperPBI Page: https://hyperpbi.com</a></p></div><span>Values-only workflow</span></header>
        <main>
