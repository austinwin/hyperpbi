...
export function AiPromptTab({data,currentSpecification,onApply,onPreview,previewReady,diagnostics}:{data:NormalizedData;currentSpecification:string;onApply:(json:string,merge:boolean)=>void;onPreview:(json:string)=>boolean;previewReady:boolean;diagnostics:InteractionDiagnostics}){
