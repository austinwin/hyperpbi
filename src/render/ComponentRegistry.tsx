import { ChartComponent, ContainerComponent, ContentComponent, ControlComponent, DashboardComponent, MapComponent, TableComponent, TabsComponent } from "../schema/hyperpbiSchema";
...
const controlTypes = new Set(["searchBox", "textInput", "numberInput", "slider", "select", "multiSelect", "toggle", "button", "buttonGroup", "filterChips", "dateRange"]);
const dataTypes = new Set(["kpi", "metricGrid", "infoCard", "statusBadge", "progressBar", "alert", "statList", "detailPanel"]);
const chartTypes = new Set(["barChart", "horizontalBarChart", "lineChart", "areaChart", "pieChart", "donutChart", "scatterChart", "gauge", "heatmap"]);
