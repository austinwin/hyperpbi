...
export const mapCapabilityRegistry: readonly MapCapabilityRegistryEntry[] = [
    ...entries("implemented", [
        ...
        "map.layers[].renderer.cluster.type", "map.layers[].renderer.cluster.radius", "map.layers[].renderer.cluster.disableAtZoom", "map.layers[].renderer.cluster.showCoverageOnHover", "map.layers[].renderer.cluster.clusterLabel", "map.layers[].renderer.cluster.aggregateField",
        ...
        "map.layers[].visibility.minZoom", "map.layers[].visibility.maxZoom", "map.layers[].visibility.conditionField", "map.layers[].visibility.conditionValues",
        "map.layers[].filter", "map.layers[].filter[].field", "map.layers[].filter[].operator", "map.layers[].filter[].value", "map.layers[].performance.maxFeatures", "map.layers[].performance.cacheMinutes", "map.layers[].performance.viewportQuery", "map.layers[].performance.requestBatchSize",
        "map.layers[].interaction", "map.layers[].interaction.enabled", "map.layers[].interaction.trigger", "map.layers[].interaction.internalMode", "map.layers[].interaction.internalScope", "map.layers[].interaction.externalMode", "map.layers[].interaction.field", "map.layers[].interaction.operator", "map.layers[].interaction.value", "map.layers[].interaction.selectionMode", "map.layers[].interaction.multiSelect", "map.layers[].interaction.showSelector", "map.layers[].interaction.clearOnSecondClick", "map.layers[].legend.visible", "map.layers[].legend.title", "map.layers[].legend.collapsed",
