...
export interface EsriPoint { x: number; y: number; z?: number; m?: number; }
export interface EsriMultiPoint { points: number[][]; hasZ?: boolean; hasM?: boolean; }
export interface EsriPolyline { paths: number[][][]; hasZ?: boolean; hasM?: boolean; }
export interface EsriPolygon { rings: number[][][]; hasZ?: boolean; hasM?: boolean; }
