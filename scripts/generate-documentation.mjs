...
<footer>Generated from canonical TypeScript metadata. Do not edit this file manually. <a href="${projectWebsite}">hyperpbi.com</a> · <a href="${projectSource}">austinwin/hyperpbi</a>. HyperPBI 1.0 remains supported as compatibility input; 2.0 is the default for new authoring.</footer>
<script>
